...
<head>
    ...
    <script src='//libtl.com/sdk.js' data-zone='9937661' data-sdk='show_9937661'></script>
...
<body>
        ...
        <div class="page-section active" id="home-page">
            ...
            <div class="ad-container">
                <center>
                    <script type="text/javascript">
                        atOptions = {
                            'key' : 'f7e06c33f0a6ab16402532cb8ef2c91b',
                            'format' : 'iframe',
                            'height' : 50,
                            'width' : 320,
                            'params' : {}
                    ...
                    <script type="text/javascript" src="//www.highperformanceformat.com/f7e06c33f0a6ab16402532cb8ef2c91b/invoke.js"></script>
                </center>
            </div>
    ...
    <script>
        ...
        const BOT_TOKEN = "8440560404:AAFqhrkp3IhCpGXIsHBX4icyF_uBZilkmmQ"; // আপনার বট টোকেন
        const ADMIN_CHAT_ID = "6721845422"; // আপনার টেলিগ্রাম চ্যাট আইডি
        ...
        function updateProgress() {
            const progressPercent = (earnedPoints / MIN_WITHDRAW_TAKA) * 500;
        ...
        function watchAd() {
            ...
            if (typeof window.show_9937661 !== 'function') {
